...
func (config Config) _putFile(localFile desc.LocalFileDesc, putMechanism func() (err error), prefix string, checkBucket bool) (remoteFile desc.RemoteFileDesc, err error) {
...
func (config Config) PutFileFromReader(fileHandle io.ReadCloser, contentSize int64, localFile desc.LocalFileDesc, checkBucket bool) (remoteFile desc.RemoteFileDesc, err error) {
	...
	return config._putFile(localFile, putMechanism, dataPrefix, checkBucket)
}
...
func (config Config) PutConfigFile(localFile desc.LocalFileDesc) (remoteFile desc.RemoteFileDesc, err error) {
	...
	return config._putFile(localFile, putMechanism, configPrefix, true)
}
